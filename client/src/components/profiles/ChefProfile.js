...
// import { useAuth } from "../Auth/AuthContext"; // Import the AuthContext hook

// const ChefProfile = () => {
//   const { user, isLoggedIn } = useAuth();
//   const authUser = user.authUser; // Use the useAuth hook to get user information
//   const {
...
//       description.trim() !== ""
//     ) {
//       setMeals([...meals, { name: meal, price, description }]);
//       setMeal("");
//       setPrice("");
//       setDescription("");
//     }
...
//   useEffect(() => {
//     // Use the user information from the useAuth hook
...
//           </Editable>
//           <Editable
//             defaultValue={editableFields.about}
//             fontSize="md"
//             maxH="50px"
//             overflow="auto"
//             isDisabled={!isEditMode}
...
//             <Editable
//               defaultValue={editableFields.password}
//               fontSize="lg"
//               isDisabled={!isEditMode}
//             >
//               <EditablePreview />
...
//             <Button bgColor="#207141" color="white" mr={3} onClick={addMeal}>
//               Add
//             </Button>
